...
- best full real-val checkpoint: `experiment_runs/real_sim/cover_layer_branch_predictor_margin_cycle_20260316/checkpoints/phase1_best_real_val_full.pt`
- full real-val macro recall: `0.9047`
- full real-val harmful fail rate: `0.0933`
