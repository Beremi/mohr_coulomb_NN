...
![Branch frequencies](../experiment_runs/real_sim/cover_layer_strain_branch_predictor_synth_only_w2048_d6_long_20260314/benchmark_branch_frequencies.png)
...
![Training history](../experiment_runs/real_sim/cover_layer_strain_branch_predictor_synth_only_w2048_d6_long_20260314/training_history.png)

## Metrics

- synthetic val accuracy / macro recall: `0.9285` / `0.9372`
- synthetic test accuracy / macro recall: `0.9289` / `0.9369`
- real val accuracy / macro recall: `0.4123` / `0.4369`
- real test accuracy / macro recall: `0.4341` / `0.4644`

## Confusions

![Confusions](../experiment_runs/real_sim/cover_layer_strain_branch_predictor_synth_only_w2048_d6_long_20260314/confusions.png)
