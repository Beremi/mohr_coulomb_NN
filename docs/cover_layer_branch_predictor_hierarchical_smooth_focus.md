...
![Branch frequencies](../experiment_runs/real_sim/cover_layer_branch_predictor_hierarchical_smooth_focus_20260315/benchmark_branch_frequencies.png)
...
![Training history](../experiment_runs/real_sim/cover_layer_branch_predictor_hierarchical_smooth_focus_20260315/training_history.png)

## Metrics

- synthetic val accuracy / macro recall: `0.9837` / `0.9872`
- synthetic test accuracy / macro recall: `0.9832` / `0.9870`
- real val accuracy / macro recall: `0.6515` / `0.6540`
- real test accuracy / macro recall: `0.7058` / `0.6843`

## Confusions

![Confusions](../experiment_runs/real_sim/cover_layer_branch_predictor_hierarchical_smooth_focus_20260315/confusions.png)
