...
![Branch frequencies](../experiment_runs/real_sim/cover_layer_strain_branch_predictor_synth_only_w256_d3_lrcycle_20260314/benchmark_branch_frequencies.png)
...
![Training history](../experiment_runs/real_sim/cover_layer_strain_branch_predictor_synth_only_w256_d3_lrcycle_20260314/training_history.png)

## Metrics

- synthetic val accuracy / macro recall: `0.9264` / `0.9350`
- synthetic test accuracy / macro recall: `0.9264` / `0.9346`
- real val accuracy / macro recall: `0.4611` / `0.4817`
- real test accuracy / macro recall: `0.4672` / `0.5019`

## Confusions

![Confusions](../experiment_runs/real_sim/cover_layer_strain_branch_predictor_synth_only_w256_d3_lrcycle_20260314/confusions.png)
